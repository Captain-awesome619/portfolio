      ...
      >
        <motion.div className="about__me">
          <div className="about__me-image">
            {/* 👇 added ref for draggable rotation */}
            <img ref={imgRef} src={ME} alt="me" />
          </div>
        </motion.div>
        ...
        <motion.div className="about__content">
          <div className="about__cards">
            ...
            <article className="about__card">
              ...
              <h5>Expertise</h5>
              <small>
                HTML CSS Javascript (React, React-Native, NextJS),<br />
          ...
          <p>
            Hello! My name is Ogunsola Toluwalase, and I'm a passionate Front-End Engineer specializing in 
            ...
            I would be thrilled to bring my skills and creativity to your team and collaborate on impactful projects. 
            I look forward to the opportunity to work with you!
          </p>

          <a href='https://dark-vale-b357a0.netlify.app/' className='btn btn-primary'>
            Check out my Blog!
          </a>
        </motion.div>
      </motion.div>
